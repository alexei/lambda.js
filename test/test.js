...
describe("collectionjs", function() {
    it("should return the type of the argument", function() {
        ...
        assert.equal(true, collection.isCompound(arguments))
        assert.equal(true, collection.isCompound([]))
        assert.equal(true, collection.isCompound(new Date()))
        assert.equal(true, collection.isCompound({}))
        assert.equal(true, collection.isCompound(/^/))
        assert.equal(false, collection.isCompound(true))
        assert.equal(false, collection.isCompound(1))
        assert.equal(false, collection.isCompound("a"))
